...
__posh_git_ps1 ()
{
    ...
    local venvstring="\[\033[1;31m\]$VIRTUAL_ENV_PROMPT\[\e[0m\]"
    if [ -z "$gitstring" ]; then
      PS1=$venvstring$ps1pc_prefix$ps1pc_suffix
    else
      PS1=$venvstring$ps1pc_prefix$git_prefix$gitstring$git_suffix$ps1pc_suffix
    fi
}
